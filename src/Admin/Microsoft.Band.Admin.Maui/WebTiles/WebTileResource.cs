...
namespace Microsoft.Band.Admin.WebTiles
{
    ...
    public class WebTileResource : IWebTileResource
    {
        ...
        private static readonly Regex AllowedVariableName = new("^([A-Za-z_]\\w*)$");
        ...
        internal List<Dictionary<string, string>> GetFeedContentMappings(
            XmlDocument data)
        {
            ...
            {
                string uniqueItemId = this.GetUniqueItemId(xmlnshelper, isRSS, xmlNodeList[index]);
                if (uniqueItemId != null)
                {
                ...
                foreach (KeyValuePair<string, string> keyValuePair in this.Content)
                {
                    ...
                    {
                        string str = xmlnshelper.ResolveNodeWithNamespace(xmlNodeList[index], keyValuePair.Value);
                        if (str != null)
        ...
        internal void ResolveContentMappings(
