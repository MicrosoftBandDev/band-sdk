...
// Assembly location: .\HealthApp.WindowsPhone_1.3.31002.2_ARM\Microsoft.Band.Admin.Phone.dll
    ...
    internal class ImageProvider : IImageProvider
    {
        ...
        public async Task<BandIcon> GetBandIconFromFileAsync(string path)
        {
            ...
            await writeableBitmap.SetSourceAsync(
                storageProvider.OpenFileRandomAccessStreamForRead(StorageProviderRoot.App, path)).AsTask();
