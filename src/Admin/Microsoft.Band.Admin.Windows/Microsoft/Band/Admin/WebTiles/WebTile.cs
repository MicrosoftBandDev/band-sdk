...
public class WebTile : IWebTile
{
    ...
    public void LoadResourceAuthentication()
    {
        ...
        foreach (WebTileResource webTileResource in privateResources)
        {
            ...
            {
                PasswordCredential val2 = val.Retrieve(text, resourceCredentialsList[0].get_UserName());
                webTileResource.Username = val2.get_UserName();
                webTileResource.Password = val2.get_Password();
            }
            else
            {
