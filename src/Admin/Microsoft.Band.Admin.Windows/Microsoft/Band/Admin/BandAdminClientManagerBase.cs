...
public abstract class BandAdminClientManagerBase
{
    ...
    internal CargoClient ConcreteConnect(ServiceInfo serviceInfo)
    {
        ...
        loggerProvider.Log(ProviderLogLevel.Info, "BandAdminClientManager.ConcreteConnect(ServiceInfo serviceInfo) succeeded: Elapsed: {0}", stopwatch.Elapsed);
        return result;
    }
    ...
    internal CargoClient ConcreteConnect(string bandId, ServiceInfo serviceInfo)
    {
        ...
        loggerProvider.Log(ProviderLogLevel.Info, "BandAdminClientManager.ConcreteConnect(string bandId, ServiceInfo serviceInfo) succeeded: Elapsed: {0}", stopwatch.Elapsed);
        return cargoClient;
    }
